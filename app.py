...
with col1:
    ...
    fig_double.update_layout(template="plotly_dark", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', xaxis=dict(title="Ekran (cm)", gridcolor='#004400'), yaxis=dict(title="Yoğunluk", gridcolor='#004400'), height=350)
...
st.markdown(f"""<div style="background-color: #000000; padding: 15px; border-radius: 10px; border: 2px solid #00FF00; margin-bottom: 40px; box-shadow: 0 0 10px #00FF00;">
<p style="margin:0; color: {SABIT_RENK};">Çifte Yarık Analizi:</p><h3 style="margin:0; color: {SABIT_RENK};">Saçak Aralığı (Δx): {round((lam * L / d) * 1000, 3)} mm</h3></div>""", unsafe_allow_html=True)
...
with col3:
    ...
    fig_single.update_layout(template="plotly_dark", paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)', xaxis=dict(title="Ekran (cm)", gridcolor='#004400'), yaxis=dict(title="Yoğunluk", gridcolor='#004400'), height=350)
...
st.markdown(f"""<div style="background-color: #000000; padding: 15px; border-radius: 10px; border: 2px solid #00FF00; box-shadow: 0 0 10px #00FF00;">
<p style="margin:0; color: {SABIT_RENK};">Tek Yarık Analizi:</p><h3 style="margin:0; color: {SABIT_RENK};">Merkezi Aydınlık Saçak Genişliği: {round((2 * lam * L / a) * 1000, 3)} mm</h3></div>""", unsafe_allow_html=True)
